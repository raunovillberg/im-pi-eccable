...
1. **`/impeccable command-name`** — Brief description of what to fix (specific context from critique findings)
2. **`/impeccable command-name`** — Brief description (specific context)
...
