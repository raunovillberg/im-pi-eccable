...
Consult the [typography reference]({{frontend_design_skill_path}}/../reference/typography.md) from `{{frontend_design_skill_path}}` for detailed guidance on scales, pairing, and loading strategies.
